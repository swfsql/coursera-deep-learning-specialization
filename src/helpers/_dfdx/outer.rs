...
impl<const M: usize, const N: usize> OuterProduct<Tensor<Rank1<N>, f32, Device>>
    for Tensor<Rank1<M>, f32, Device>
{
    type Output = Tensor<Rank2<M, N>, f32, Device>;
    /// Implements the outer-product between two 1D Tensors.
    fn outer(self, rhs: Tensor<Rank1<N>, f32, Device>) -> Self::Output {
